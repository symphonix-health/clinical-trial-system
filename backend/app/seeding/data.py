...
SITES: list[dict[str, Any]] = [
    ...
    {"study_index": 2, "site_code": "VAC-01", "name": "Children's Health Ireland at Crumlin", "pi": "dr_maria_garcia", "capacity": 4, "status": "activated"},
    {"study_index": 2, "site_code": "VAC-02", "name": "University Hospital Galway", "pi": "dr_tom_wilson", "capacity": 1, "status": "pending"},
]
...
ADVERSE_EVENTS: list[dict[str, Any]] = [
    ...
    {"study_index": 0, "subject_index": 2, "onset_date": dt.date(2026, 4, 10), "severity": "severe", "seriousness": "life_threatening", "causality": "related", "susar": True, "expectedness": "unexpected"},
    {"study_index": 1, "subject_index": 20, "onset_date": dt.date(2026, 5, 12), "severity": "moderate", "seriousness": "serious", "causality": "possibly_related", "susar": True, "expectedness": "unexpected"},
