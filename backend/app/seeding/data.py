...
SITES: list[dict[str, Any]] = [
    ...
    },
    {
        "study_index": 0,
        "site_code": "ONC-05",
        "name": "Southern Oncology Day Unit",
        "pi": "dr_emma_white",
        "capacity": 1,
        "status": "pending",
    },
    ...
    },
    {
        "study_index": 2,
        "site_code": "VAC-01",
        "name": "Children's Health Ireland at Crumlin",
        "pi": "dr_maria_garcia",
        "capacity": 4,
        "status": "activated",
    },
...
PROTOCOL_DEVIATIONS: list[dict[str, Any]] = [
    {
        ...
        "description": "Subject enrolled outside window",
        "severity": "major",
    },
    {
        "study_index": 0,
        ...
        "description": "Visit 2 occurred 3 days late",
        "severity": "minor",
    },
    {
        "study_index": 0,
        "subject_index": 1,
        "category": "ip_dosing",
        "description": "Dose administered 2 hours late",
        "severity": "minor",
    },
    {
        "study_index": 1,
        "subject_index": 22,
        "category": "eligibility",
        "description": "ECG performed out of window",
        "severity": "minor",
    },
    {
        "study_index": 1,
        ...
        "description": "Week 4 follow-up missed",
        "severity": "major",
    },
]
...
PRODUCTS: list[dict[str, Any]] = [
    {
        "sku": "ONCO-IP-001",
        "name": "Kinase inhibitor capsules 50mg",
        "lot": "LOT-A001",
        "site_study": 0,
        "site_code": "ONC-01",
        "qty": 200,
    ...
    {
        "sku": "CARD-IP-001",
        "name": "Cardioprotective tablets 10mg",
        "lot": "LOT-B001",
        "site_study": 1,
        "site_code": "CAR-01",
        "qty": 300,
...
AGENT_SUBJECTS: list[dict[str, Any]] = [
    {
        "principal": "agent://triage-chest-pain/v1",
        "persona": "triage_chest_pain",
        "contract": "contract-001",
        "model": "v1.2.0",
        "owner": "ai_team_1",
        "autonomy": "shadow",
        "safety": "low",
        "source": "global_agent_registry",
    },
    {
        "principal": "agent://med-rec/v1",
        "persona": "medication_reconciliation",
        "contract": "contract-002",
        "model": "v2.0.1",
        "owner": "ai_team_2",
        "autonomy": "advisory",
        "safety": "medium",
        "source": "nexus_a2a_protocol",
    },
    {
        "principal": "agent://discharge/v1",
        "persona": "discharge_planning",
        "contract": "contract-003",
        "model": "v1.5.0",
        "owner": "ai_team_3",
        "autonomy": "auto_with_threshold_hitl",
        "safety": "high",
        "source": "direct",
    },
    {
        "principal": "agent://triage-chest-pain/v2",
        "persona": "triage_chest_pain",
    ...
    {
        "principal": "agent://differential/v1",
        "persona": "differential_review",
    ...
    {
        "principal": "agent://treatment/v1",
        "persona": "treatment_plan",
    ...
    {
        "principal": "agent://safety-esc/v1",
        "persona": "safety_escalation",
...
AGENT_COHORTS: list[dict[str, Any]] = [
    ...
    {
        "name": "Medication reconciliation agents",
        "type": "single_agent",
        "profile": "med_rec",
